...
export const ACCESS_FUNCTIONS = [
  ...
  },
  {
    ...
    // Рома, я на Канарах, обращайся на ты» — это три факта; тремя вызовами это
    ...
    about:
      ...
      "Зови, когда он рассказал о себе свободно: «меня зовут Рома, я на Канарах, обращайся на ты». " +

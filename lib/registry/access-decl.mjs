...
export const ACCESS_FUNCTIONS = [
  ...
  },
  {
    ...
    about:
      "Значения признака, которые уже накоплены: последние сверху. Можно сузить субъектом (чей факт) " +
      "и охватом (где он верен). Отказ слоя данных и «значений нет» — РАЗНЫЕ ответы.",
    params: [
      { name: "key", type: "string", required: true, about: "Ключ признака, например intent.where" },
      { name: "subject", type: "string", required: false, about: "Чей факт: ключ субъекта" },

...
import { HeaderAuth } from "./header-auth.client";
...
// 🪦 «КНОПКА НАВИГАЦИИ СПРАВА» ОТМЕНЕНА 2026-09-07 СЛОВОМ ВЛАДЕЛЬЦА: «кнопка
// настройки вообще не должна быть видна пока я не авторизован; когда буду
// авторизован — должна появиться слева». Справа теперь аккаунт — как на 3000.
// 🪦 «КНОПКИ ВХОДА ЗДЕСЬ НЕТ ПО УСТРОЙСТВУ» ОТМЕНЕНО ТЕМ ЖЕ РЕШЕНИЕМ: главная
// стала публичной (156-1), и на публичной странице вход обязан быть виден.
// Прежняя редакция ниже оставлена историей.
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-border bg-background/80 backdrop-blur-sm">
      <div className="flex h-14 w-full items-center px-6 md:px-8">
        ...
        <HeaderAuth lang={lang} settingsLabel={ui.settings} />
      </div>
    </header>
  );
}

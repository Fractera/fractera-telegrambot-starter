...
export function TelegramSettings({
  ...
  return (
    <div data-telegram-settings="ready" className="flex flex-col gap-4">
      {/* 🪦 КАРТОЧКА «TELEGRAM-БОТ — АГЕНТ АВТОМАТИЗАЦИИ» УЕХАЛА ОТСЮДА 181-7 в
          пункт меню «Подключение Telegram-бота» — вместе с активацией, которая
          жила в окне терминала. Слово владельца: «вместо того чтобы бот находился
          в одном месте мы его разорвали в две разные части». */}

      {/* ── 2. Ключ Anthropic ───────────────────────────────────────────
          🪦 «ОБА КЛЮЧА РЯДОМ И ПОСЛЕ ПОДПИСКИ» — ОТМЕНЕНО 2026-09-10: ключ OpenAI
          уехал на свою вкладку (181-2), карточка подписки убрана отсюда (181-6).
          На экране остались бот, ключ Anthropic и расписание. */}
